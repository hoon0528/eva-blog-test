...
여러 오픈소스마다 각 각 지원하는 모델 범위가 다르고 사용 편의성에서도 많은 차이가 있습니다.
...
- **vLLM**
  ...
  - 공식 문서와 예제가 잘 정리되어 있고, LangChain 등 상위 프레임워크와의 연동 사례도 풍부해 EVA의 기존 Python / FastAPI 기반 스택에 쉽게 적용 가능
...
*<p align="center">Figure 1. Autoregressive 모델 추론 방식</p>*
...
*<p align="center">Figure 2. 비효율적인 GPU 메모리 사용</p>*
...
*<p align="center">Figure 3. Paged 메모리</p>*
...
*<p align="center">Figure 6. Chunked Prefill</p>*
...
*<p align="center">Figure 7. Compute on GPU</p>*
...
*<p align="center">Figure 8. Standard Attention</p>*
...
*<p align="center">Figure 9. Flash Attention</p>*
...
EVA는 앞으로도 새로운 모델과 엔진을 계속 실험하면서, “**우리 서비스에 맞는 적당한 복잡도와 성능**”을 찾아가는 과정을 계속할 것이고, vLLM은 그 과정 중 하나일 뿐입니다.
